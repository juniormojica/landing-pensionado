...
const AboutUs = ({ handleCTAClick }) => {
    ...
    return (
        <section id="nosotros" className="py-12 sm:py-14 md:py-16 lg:py-20 bg-gradient-to-b from-white via-gray-50 to-white overflow-hidden">
            <div className="container mx-auto px-4 sm:px-5 md:px-6 lg:px-8">
                ...
                <motion.div
                    ...
                    className="text-center mb-10 sm:mb-11 md:mb-12 lg:mb-16"
                >
                    <motion.div
                        initial={{ scale: 0 }}
                        whileInView={{ scale: 1 }}
                    ...
                    >
                        <span className="bg-primary/10 text-primary px-4 py-2 rounded-full text-sm sm:text-base md:text-base font-semibold">
                            Nuestra Historia
                        </span>
                    </motion.div>
                    <h2 className="text-3xl sm:text-3xl md:text-4xl lg:text-5xl font-bold mb-4 sm:mb-5 md:mb-6 text-gray-900">
                        20 Años Siendo Tu Hogar Estudiantil
                    </h2>
                    <div className="max-w-3xl mx-auto">
                        <p className="text-base sm:text-lg md:text-lg lg:text-xl text-gray-600 leading-relaxed">
                ...
                <motion.div
                    ...
                    whileInView="visible"
                    viewport={{ once: true }}
                    className="grid sm:grid-cols-1 md:grid-cols-2 gap-8 sm:gap-10 md:gap-12 mb-12 sm:mb-14 md:mb-16 items-center"
                >
                    {/* Left: Story */}
                    ...
                    <motion.div variants={itemVariants}>
                        <div className="grid grid-cols-2 gap-4 sm:gap-5 md:gap-6">
                            {stats.map((stat, index) => (
                                ...
                                >
                                    <stat.icon className={`w-8 h-8 sm:w-9 sm:h-9 md:w-10 md:h-10 ${stat.color} mb-3`} />
                                    <div className="text-3xl sm:text-3xl md:text-4xl font-bold text-gray-900 mb-2">
                                        {stat.number}
                                    </div>
                ...
                >
                    <motion.h3
                        ...
                        className="text-2xl sm:text-3xl md:text-3xl lg:text-4xl font-bold text-center mb-8 sm:mb-10 md:mb-12 text-gray-900"
                    >
                        Nuestros Valores
                    </motion.h3>
                    <div className="grid sm:grid-cols-1 md:grid-cols-3 gap-6 sm:gap-7 md:gap-8">
                        {values.map((value, index) => (
                            <motion.div
                                ...
                                variants={itemVariants}
                                whileHover={{ y: -10 }}
                                className="bg-gradient-to-br from-white to-gray-50 rounded-2xl p-6 sm:p-7 md:p-8 shadow-lg hover:shadow-xl transition-all duration-300 border border-gray-100"
                            >
                                <div className="bg-primary/10 w-14 h-14 sm:w-15 sm:h-15 md:w-16 md:h-16 rounded-xl flex items-center justify-center mb-4 sm:mb-5 md:mb-6">
                                    <value.icon className="w-7 h-7 sm:w-7 sm:h-7 md:w-8 md:h-8 text-primary" />
                                </div>
                                <h4 className="text-xl sm:text-xl md:text-2xl font-bold mb-3 sm:mb-3 md:mb-4 text-gray-900">
                                    {value.title}
                                </h4>
                ...
                <motion.div
                    ...
                    viewport={{ once: true }}
                    transition={{ duration: 0.6 }}
                    className="bg-gradient-to-r from-primary to-primaryDark rounded-3xl p-8 sm:p-10 md:p-12 text-center text-white shadow-2xl"
                >
                    <h3 className="text-2xl sm:text-3xl md:text-3xl lg:text-4xl font-bold mb-4 sm:mb-5 md:mb-6">
                        Sé Parte de Nuestra Historia
                    </h3>
                    <p className="text-base sm:text-lg md:text-lg lg:text-xl mb-6 sm:mb-7 md:mb-8 opacity-90 max-w-2xl mx-auto">
