...
const PriceSimulator = () => {
    ...
    return (
        <section id="simulador" className="py-8 md:py-16 bg-gradient-to-br from-blue-50 via-white to-green-50 overflow-hidden">
            <div className="container mx-auto px-3 md:px-4 max-w-6xl">
                ...
                >
                    <div className="inline-flex items-center gap-2 bg-accentGreen/10 text-accentGreen px-3 md:px-4 py-1.5 md:py-2 rounded-full mb-3 md:mb-4">
                        <Calculator className="w-4 h-4 md:w-5 md:h-5" />
                        <span className="font-semibold text-sm md:text-base">Calculadora Interactiva</span>
                    </div>
                    <h2 className="text-2xl md:text-4xl lg:text-5xl font-bold mb-3 md:mb-4 bg-gradient-to-r from-gray-900 to-gray-700 bg-clip-text text-transparent px-2">
                ...
                <div className="flex flex-col lg:grid lg:grid-cols-3 gap-4 md:gap-8">
                    ...
                    <div className="lg:col-span-2 order-2 lg:order-1">
                        <motion.div
                            ...
                            viewport={{ once: true }}
                            className="bg-white rounded-2xl md:rounded-3xl shadow-xl p-4 md:p-6 lg:p-8"
                        >
                            {/* Progress Bar */}
                                ...
                                <div className="flex justify-between items-center mb-3 md:mb-4">
                                    {steps.map((step, index) => (
                                        <div key={step.id} className="flex items-center flex-1">
                                            <div className={`flex items-center justify-center w-8 h-8 md:w-10 md:h-10 rounded-full transition-all duration-300 ${index <= currentStep
                                ...
                                >
                                    <div className="mb-4 md:mb-8">
                                        <div className="flex items-center gap-2 md:gap-3 mb-3 md:mb-4">
                                            <div className="p-2 md:p-3 bg-accentGreen/10 rounded-lg md:rounded-xl">
                                                <currentStepData.icon className="w-6 h-6 md:w-8 md:h-8 text-accentGreen" />
                                            </div>
                                            <div>
                                        ...
                                        {currentStepData.options.map((option) => {
                                            ...
                                            return (
                                                <motion.button
                                                    ...
                                                    className={`w-full p-4 md:p-6 rounded-xl md:rounded-2xl border-2 transition-all duration-300 text-left relative overflow-hidden active:scale-95 ${isSelected
                                                ...
                                                >
                                                    {option.popular && (
                                                        <div className="absolute top-2 right-2 md:top-0.5 md:right-4">
                                                            <span className="bg-secondaryYellow text-black px-2 md:px-3 py-0.5 md:py-1 rounded-full text-xs font-bold flex items-center gap-1">
                                                                Popular
                                                            </span>
                                                        </div>
                                                    )}
                                                    ...
                                                    <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-3 md:gap-4">
                                                        <div className="flex-1">
                                                            <div className="flex items-center gap-2 mb-2">
                                                                {isSelected && (
                                                                    <CheckCircle2 className="w-4 h-4 md:w-5 md:h-5 text-accentGreen flex-shrink-0" />
                                                                )}
                                                        ...
                                                        <div className="text-left md:text-right flex md:flex-col items-center md:items-end justify-between md:justify-start">
                                    ...
                                    <div className="flex gap-2 md:gap-4">
                                        <button
                                            ...
                                            className={`flex items-center gap-1 md:gap-2 px-3 md:px-6 py-2.5 md:py-3 rounded-lg md:rounded-xl font-semibold text-sm md:text-base transition-all duration-300 active:scale-95 ${currentStep === 0
                                        ...
                                        {currentStep < steps.length - 1 ? (
                                            <button
                                                ...
                                                className={`flex-1 flex items-center justify-center gap-1 md:gap-2 px-4 md:px-6 py-2.5 md:py-3 rounded-lg md:rounded-xl font-semibold text-sm md:text-base transition-all duration-300 active:scale-95 ${isStepCompleted
                                            ...
                                            <button
                                                ...
                                                className={`flex-1 flex items-center justify-center gap-1 md:gap-2 px-4 md:px-6 py-2.5 md:py-3 rounded-lg md:rounded-xl font-semibold text-sm md:text-base transition-all duration-300 active:scale-95 ${allStepsCompleted
                                                    ? 'bg-accentGreen text-white hover:bg-accentGreen/90 shadow-lg'
                                                    : 'bg-gray-100 text-gray-400 cursor-not-allowed'
                                                    }`}
                                            >
                    ...
                    <div className="lg:col-span-1 order-1 lg:order-2">
                        <motion.div
                            ...
                            whileInView={{ opacity: 1, x: 0 }}
                            viewport={{ once: true }}
                            className="bg-gradient-to-br from-accentGreen to-accentGreen/90 rounded-2xl md:rounded-3xl shadow-xl p-4 md:p-6 lg:p-8 text-white sticky top-20 lg:top-4"
                        >
                                    ...
                                    <>
                                        {getBreakdown().map((item, index) => (
                                            <motion.div
                                                ...
                                                className="flex justify-between items-center pb-2 md:pb-3 border-b border-white/20"
                                            >
