  ...
  return (
    <section className="bg-gray-100 dark:bg-gray-800 py-12">
      <div className="container mx-auto px-4">
        <h2 className="text-3xl font-bold text-center mb-8 font-lato">Caracteristicas</h2>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {features.map((feature, index) => (
            <div key={index} className="bg-white dark:bg-gray-900 p-6 rounded-lg shadow">
              ...
              <h3 className="text-xl font-bold mb-2 text-accentGreen">{feature.title}</h3>
              <p className="text-gray-700 dark:text-gray-300 font-lato">{feature.description}</p>
            </div>
          ))}
        </div>
      </div>
